...
country = {
	...
	COLONIZATION_CREATE_STATE_COST = 400,
	...
	RESEARCH_POINTS_ON_CONQUER_MULT = 150, -- multiplier to RP got by conquering as unciv when got enacted military reforms
...
pops = {
	...
	PROMOTION_ASSIMILATION_CHANCE = 0.5,
